var jsPsychAudioHtmlForm = (function (jspsych) {
  'use strict';

  const info = {
      name: "audio-html-form",
      parameters: {
  ...
  class SurveyHtmlFormPlugin {
      ...
      trial(display_element, trial) {
          ...
          // audio
          html += '<audio autoplay id="first_audio"> <source src="' + trial.stimulus + '" type="audio/ogg"> </audio>'
          //element.addEventListener("ended", myFunction);
          ...
          // add submit button
          html +=
              '<input type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" disabled value="' +
                  trial.button_label +
                  '"></input>';
          html += "</form>";
